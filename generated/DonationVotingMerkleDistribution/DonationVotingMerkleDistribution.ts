...
export class Appealed extends ethereum.Event {
  get params(): Appealed__Params {
    return new Appealed__Params(this);
  }
}

export class Appealed__Params {
  _event: Appealed;

  constructor(event: Appealed) {
    this._event = event;
  }
...
export class DonationVotingMerkleDistribution__distributionMetadataResult {
  value0: BigInt;
  value1: string;
...
export class DonationVotingMerkleDistribution__getPayoutsResultValue0Struct extends ethereum.Tuple {
  get recipientAddress(): Address {
...
export class DonationVotingMerkleDistribution__getRecipientResultValue0Struct extends ethereum.Tuple {
  ...
  get metadata(): DonationVotingMerkleDistribution__getRecipientResultValue0MetadataStruct {
    return changetype<
      DonationVotingMerkleDistribution__getRecipientResultValue0MetadataStruct
    >(this[2].toTuple());
  }
}

export class DonationVotingMerkleDistribution__getRecipientResultValue0MetadataStruct extends ethereum.Tuple {
  get protocol(): BigInt {
    return this[0].toBigInt();
  }
...
export class DonationVotingMerkleDistribution extends ethereum.SmartContract {
  static bind(address: Address): DonationVotingMerkleDistribution {
    return new DonationVotingMerkleDistribution(
  ...
  claims(param0: Address, param1: Address): BigInt {
    let result = super.call("claims", "claims(address,address):(uint256)", [
      ethereum.Value.fromAddress(param0),
  ...
  try_claims(param0: Address, param1: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("claims", "claims(address,address):(uint256)", [
      ethereum.Value.fromAddress(param0),
      ethereum.Value.fromAddress(param1)
    ]);
    if (result.reverted) {
  ...
  distributionMetadata(): DonationVotingMerkleDistribution__distributionMetadataResult {
    let result = super.call(
    ...
    return new DonationVotingMerkleDistribution__distributionMetadataResult(
      result[0].toBigInt(),
      result[1].toString()
    );
  }

  try_distributionMetadata(): ethereum.CallResult<
    DonationVotingMerkleDistribution__distributionMetadataResult
  > {
    let result = super.tryCall(
      "distributionMetadata",
      "distributionMetadata():(uint256,string)",
    ...
    return ethereum.CallResult.fromValue(
      new DonationVotingMerkleDistribution__distributionMetadataResult(
        value[0].toBigInt(),
        value[1].toString()
      )
    );
  ...
  getInternalRecipientStatus(_recipientId: Address): i32 {
    let result = super.call(
      "getInternalRecipientStatus",
      "getInternalRecipientStatus(address):(uint8)",
  ...
  try_getInternalRecipientStatus(
  ...
  getPayouts(
    ...
    _data: Array<Bytes>
  ): Array<DonationVotingMerkleDistribution__getPayoutsResultValue0Struct> {
    let result = super.call(
      "getPayouts",
    ...
    return result[0].toTupleArray<
      DonationVotingMerkleDistribution__getPayoutsResultValue0Struct
    >();
  }
  ...
  getRecipient(
    _recipientId: Address
  ): DonationVotingMerkleDistribution__getRecipientResultValue0Struct {
    let result = super.call(
      "getRecipient",
...
export class ClaimCall__Inputs {
  ...
  get _claims(): Array<ClaimCall_claimsStruct> {
    return this._call.inputValues[0].value.toTupleArray<
      ClaimCall_claimsStruct
    >();
  }
}
...
export class ClaimCall_claimsStruct extends ethereum.Tuple {
  get recipientId(): Address {
    return this[0].toAddress();
  }
...
export class ReviewRecipientsCall__Inputs {
  ...
  get statuses(): Array<ReviewRecipientsCallStatusesStruct> {
    return this._call.inputValues[0].value.toTupleArray<
      ReviewRecipientsCallStatusesStruct
    >();
  }
}
